...
public class ConvertToXmlUserShould : ConverterControllerBaseTest
{
    ...
    {
        //Arrange
        var request = new ConvertToXmlRequest<UserMetadata>
        {
        ...
        var senderResult = _mockSender.Setup(s => s.Send(It.IsAny<ConvertToXmlCommand<UserMetadata>>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(response);

        //Act
        var result = await _controller.ConvertToXmlUser(request);
